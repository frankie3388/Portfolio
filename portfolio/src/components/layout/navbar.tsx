...
const Navbar = () => {
    ...
    return (
        <div className="z-20">
            ...
            <div
                className={`h-1/2 ${isHovered ? 'w-40 text-primary-500' : 'w-20'} bg-transparent text-white flex flex-col fixed transition-all duration-300 z-20 hidden sm:flex hover:cursor-pointer`}
